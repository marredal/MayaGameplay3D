...
namespace SYNCOLOR
{
  ...
  {
    ERROR_NONE = 0x00,
   ERROR_UTILS_ALL_INVALID_ROI_WIDTH = (SYNCOLOR::FEATURE_UTILS_ALL + 1),
   ERROR_UTILS_ALL_INVALID_ROI_HEIGHT = (SYNCOLOR::FEATURE_UTILS_ALL + 2),
   ERROR_UTILS_ALL_ILLEGAL_PIXEL_FORMAT = (SYNCOLOR::FEATURE_UTILS_ALL + 3),
   ERROR_UTILS_ALL_FILE_LOCK_FAILED = (SYNCOLOR::FEATURE_UTILS_ALL + 4),
   ERROR_UTILS_ALL_FILE_UNLOCK_FAILED = (SYNCOLOR::FEATURE_UTILS_ALL + 5),
   ERROR_UTILS_ALL_STRING_HAS_NO_ALPHANUMERIC = (SYNCOLOR::FEATURE_UTILS_ALL + 6),
   ERROR_UTILS_ALL_LANG_TEST = (SYNCOLOR::FEATURE_UTILS_ALL + 7),
   ERROR_UTILS_ALL_UNKNOWN_XML_TAG = (SYNCOLOR::FEATURE_UTILS_ALL + 8),
   ...
   ERROR_TRANSFORM_ACES_UNKNOWN_STYLE = (SYNCOLOR::FEATURE_TRANSFORM_ACES + 2),
   ...
   ERROR_XML_READER_OP_VERSION_MISMATCH = (SYNCOLOR::FEATURE_XML_READER + 29),
   ERROR_XML_READER_SOPNODE_WRONG_NUM_VALUES = (SYNCOLOR::FEATURE_XML_READER + 30),
   ERROR_XML_READER_SOPNODE_MISSING_SLOPE = (SYNCOLOR::FEATURE_XML_READER + 31),
   ERROR_XML_READER_SOPNODE_MISSING_OFFSET = (SYNCOLOR::FEATURE_XML_READER + 32),
   ERROR_XML_READER_SOPNODE_MISSING_POWER = (SYNCOLOR::FEATURE_XML_READER + 33),
   ERROR_XML_READER_SATNODE_WRONG_NUM_VALUES = (SYNCOLOR::FEATURE_XML_READER + 34),
   ERROR_XML_READER_INVALID_VALUE_FOR_DYNAMIC_PARAMETER = (SYNCOLOR::FEATURE_XML_READER + 35),
   ERROR_XML_READER_ILLEGAL_BYPASS_VALUE = (SYNCOLOR::FEATURE_XML_READER + 36),
   ERROR_XML_READER_ILLEGAL_HUE_ADJUST_VALUE = (SYNCOLOR::FEATURE_XML_READER + 37),
   ERROR_XML_READER_INTERNAL_PARSING_ERROR = (SYNCOLOR::FEATURE_XML_READER + 38),
   ERROR_XML_READER_ILLEGAL_SAT_ADJUST_VALUE = (SYNCOLOR::FEATURE_XML_READER + 39),
   ERROR_XML_READER_TOO_MANY_INDEX_MAPS = (SYNCOLOR::FEATURE_XML_READER + 40),
   ...
   ERROR_XML_CATALOG_MANAGER_VIEW_TRANSFORM_NOT_FOUND = (SYNCOLOR::FEATURE_XML_CATALOG_MANAGER + 5),
   ERROR_XML_CATALOG_MANAGER_INPUT_SPACE_TRANSFORM_NOT_FOUND = (SYNCOLOR::FEATURE_XML_CATALOG_MANAGER + 6),
   ERROR_XML_CATALOG_MANAGER_WORKING_SPACE_MISSING_OUTPUT_SPACE_ID = (SYNCOLOR::FEATURE_XML_CATALOG_MANAGER + 5),
   ERROR_XML_CATALOG_MANAGER_TRANSFORM_TO_CONNECTION_SPACE_NOT_FOUND = (SYNCOLOR::FEATURE_XML_CATALOG_MANAGER + 6),
   ERROR_XML_CATALOG_MANAGER_TRANSFORM_FROM_CONNECTION_SPACE_NOT_FOUND = (SYNCOLOR::FEATURE_XML_CATALOG_MANAGER + 7),
   ERROR_XML_CATALOG_MANAGER_UNABLE_TO_CONNECT = (SYNCOLOR::FEATURE_XML_CATALOG_MANAGER + 8),
   ERROR_XML_CATALOG_MANAGER_ILLEGAL_IMAGE_STATE = (SYNCOLOR::FEATURE_XML_CATALOG_MANAGER + 9),
   ERROR_XML_CATALOG_MANAGER_TRANSFORMS_NOT_INSTALLED = (SYNCOLOR::FEATURE_XML_CATALOG_MANAGER + 10),
   ERROR_XML_CATALOG_MANAGER_SHARED_CATALOG_ERROR = (SYNCOLOR::FEATURE_XML_CATALOG_MANAGER + 11),
   ERROR_XML_CATALOG_MANAGER_PACKAGE_NOT_INSTALLED = (SYNCOLOR::FEATURE_XML_CATALOG_MANAGER + 12),
   ERROR_XML_CATALOG_MANAGER_INPUT_SPACE_MISSING_OUTPUT_SPACE_ID = (SYNCOLOR::FEATURE_XML_CATALOG_MANAGER + 13),
   ERROR_XML_CATALOG_MANAGER_ILLEGAL_ID = (SYNCOLOR::FEATURE_XML_CATALOG_MANAGER + 14),
   ERROR_XML_CATALOG_MANAGER_ILLEGAL_PRODUCT = (SYNCOLOR::FEATURE_XML_CATALOG_MANAGER + 15),
   ERROR_XML_CATALOG_MANAGER_MIXING_TEMPLATE_PARAMETERS_NOT_SUPPORTED = (SYNCOLOR::FEATURE_XML_CATALOG_MANAGER + 16),
   ERROR_XML_CATALOG_MANAGER_NATIVE_CATALOG_MISSING = (SYNCOLOR::FEATURE_XML_CATALOG_MANAGER + 17),
   ...
   ERROR_RENDERER_GPU_ADAPTOR_UNDEFINED_LANGUAGE = (SYNCOLOR::FEATURE_RENDERER_GPU + 1),
   ERROR_RENDERER_GPU_ADAPTOR_ERROR = (SYNCOLOR::FEATURE_RENDERER_GPU + 2),
   ERROR_RENDERER_GPU_UNSUPPORTED_BAYER_MATRIX_SIZE = (SYNCOLOR::FEATURE_RENDERER_GPU + 3),
