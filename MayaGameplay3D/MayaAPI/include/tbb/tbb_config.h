...
/** By default, use C++11 classes if available **/
        ...
        #if (__INTEL_COMPILER && __INTEL_COMPILER <= 1500) 
...
//TODO: recheck for different clang versions 
    ...
    /** That's a bug in Intel compiler 11.1.044/IA-32 architecture/Windows, that leads to a worker thread crash on the thread's startup. **/
    ...
    /** The Intel compiler for IA-32 architecture (Linux|OS X) crashes or generates
...
/*In a PIC mode some versions of GCC 4.1.2 generate incorrect inlined code for 8 byte __sync_val_compare_and_swap intrinsic */
    ...
    // even if the object specifies 8-byte alignment.  On such platforms, the IA-32 architecture implementation
